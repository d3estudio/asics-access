  ...
  def get_invite_strings
    invite_strings = {
      EN: {
        ...
        img_04: Rails.configuration.custom_base_url + '/images/email/invitation/en/asics_04.jpg?v=3',
        img_04b: Rails.configuration.custom_base_url + '/images/email/invitation/en/asics_04b.jpg',
        img_05: Rails.configuration.custom_base_url + '/images/email/invitation/en/asics_05.jpg?v=3',
      ...
      PT: {
        ...
        img_04: Rails.configuration.custom_base_url + '/images/email/invitation/pt/asics_04.jpg?v=3',
        img_04b: Rails.configuration.custom_base_url + '/images/email/invitation/pt/asics_04b.jpg?',
        img_05: Rails.configuration.custom_base_url + '/images/email/invitation/pt/asics_05.jpg?v=3',
  ...
  def get_confirm_strings
    confirm_strings = {
      EN: {
        ...
        img_06a: Rails.configuration.custom_base_url + '/images/email/confirmation/en/asics_06a.jpg?v=2',
        img_06b: Rails.configuration.custom_base_url + '/images/email/confirmation/en/asics_06b.jpg?v=2',
        img_06c: Rails.configuration.custom_base_url + '/images/email/confirmation/en/asics_06c.jpg?v=2',
        img_06d: Rails.configuration.custom_base_url + '/images/email/confirmation/en/asics_06d.jpg?v=2',
      ...
      PT: {
        ...
        img_06a: Rails.configuration.custom_base_url + '/images/email/confirmation/pt/asics_06a.jpg?v=2',
        img_06b: Rails.configuration.custom_base_url + '/images/email/confirmation/pt/asics_06b.jpg?v=2',
        img_06c: Rails.configuration.custom_base_url + '/images/email/confirmation/pt/asics_06c.jpg?v=2',
        img_06d: Rails.configuration.custom_base_url + '/images/email/confirmation/pt/asics_06d.jpg?v=2',
